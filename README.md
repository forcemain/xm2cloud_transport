# xm2cloud_transport
#### 简单介绍:
>[xm2cloud_transport](https://github.com/xmdevops/xm2cloud_transport) 主要模拟Logstash软件架构的思路实现,目前主要用于APM监控前端,兼容PY2.6+
...
#### 更新日志:
* 2017-12-20 修复JsonRpc异步Client和Graphite Client断线重连
